...
class UltimateSQLFiller():
    ...
    Main Class
    """
    def __init__(self, database = "djtest1"):
        """
        Returns
        -------
        None.
    ...
    def excute_sql_line(self, mysql_line, mysql_values = []):  
        try:
            ...
            # print(type(errors))    # the exception instance
            # print(errors.args)     # arguments stored in .args
            # print(errors) 
            # assert(0)
    ...
    def fill_proteinset_table(self, my_values):
        ...
        try:
            my_values += [self.my_cursor.fetchall()[0][0]]    
        except:
    ...
    def spiecies_extractorV2(self, my_location = "AdditionalData"):
        """
